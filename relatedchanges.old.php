 ...
 */   
	...
	$link = $_SERVER['PHP_SELF'] . '?lang=' . $lang . '&family=' . $family . '&category=' . $category . '&d=' . $d;
    $hide = ($hideminor ? '&hideminor=1' : '') . ($hideanons ? '&hideanons=1' : '') . ($hidebots ? '&hidebots=1' : '') . ($hideliu ? '&hideliu=1' : '') . ($hidepatrolled ? '&hidepatrolled=1' : '');
    ...
    echo '<br>';
    echo '<a href="' . $link . ($hideanons ? '&hideanons=1' : '') . ($hidebots ? '&hidebots=1' : '') . ($hideliu ? '&hideliu=1' : '') . ($hidepatrolled ? '&hidepatrolled=1' : '') . '&hideminor=' . ($hideminor ? '0" title="relatedchanges">Show</a>' : '1" title="relatedchanges">Hide</a>' ) . ' minor edits | ';
    echo '<a href="' . $link . ($hideanons ? '&hideanons=1' : '') . ($hideminor ? '&hideminor=1' : '') . ($hideliu ? '&hideliu=1' : '') . ($hidepatrolled ? '&hidepatrolled=1' : '') . '&hidebots=' . ($hidebots ? '0" title="relatedchanges">Show</a>' : '1" title="relatedchanges">Hide</a>' ) . ' bots | ';
    echo '<a href="' . $link . ($hideminor ? '&hideminor=1' : '') . ($hidebots ? '&hidebots=1' : '') . ($hideliu ? '&hideliu=1' : '') . ($hidepatrolled ? '&hidepatrolled=1' : '') . '&hideanons=' . ($hideanons ? '0" title="relatedchanges">Show</a>' : '1" title="relatedchanges">Hide</a>' ) . ' anonymous users | ';
    echo '<a href="' . $link . ($hideanons ? '&hideanons=1' : '') . ($hidebots ? '&hidebots=1' : '') . ($hideminor ? '&hideminor=1' : '') . ($hidepatrolled ? '&hidepatrolled=1' : '') . '&hideliu=' . ($hideliu ? '0" title="relatedchanges">Show</a>' : '1" title="relatedchanges">Hide</a>' ) . ' logged-in users | ';
    echo '<a href="' . $link . ($hideanons ? '&hideanons=1' : '') . ($hidebots ? '&hidebots=1' : '') . ($hideminor ? '&hideminor=1' : '') . ($hideliu ? '&hideliu=1' : '') . '&hidepatrolled=' . ($hidepatrolled ? '0" title="relatedchanges">Show</a>' : '1" title="relatedchanges">Hide</a>' ) . ' patrolled edits';

    echo '</div><ul>';
    
    $sql = 'SELECT rc_id, rc_this_oldid, rc_title, rc_timestamp, rc_comment, rc_namespace, 
           rc_minor, rc_new, rc_user_text, rc_bot, rc_patrolled
